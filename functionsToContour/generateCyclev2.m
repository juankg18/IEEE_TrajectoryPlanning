function [TrayTotalX,TrayTotalY]=generateCyclev2(Xtotal,Ytotal,XtotalW,YtotalW,XtotalE,YtotalE,XtotalQ,YtotalQ,XtotalA,YtotalA,XtotalB,YtotalB,Diametro)
Bin=size(Xtotal);
Bin=Bin(2);
Bb=~isnan(Xtotal(:,Bin));
%Contorno
...
XTrayTotal=[Xcutnn2;TrayTotalX5;Xcutnn];
YTrayTotal=[Ycutnn2;TrayTotalY5;Ycutnn];
else
XTrayTotal=[Xcutnn2;flip(TrayTotalX5);Xcutnn];
YTrayTotal=[Ycutnn2;flip(TrayTotalY5);Ycutnn];
end
